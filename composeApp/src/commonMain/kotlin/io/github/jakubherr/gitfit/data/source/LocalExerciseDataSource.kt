...
class LocalExerciseDataSource(
    ...
    override fun getAll() = db.exerciseQueries.selectAll(mapper = ::toExercise).asFlow().mapToList(Dispatchers.IO)

    fun getAl() = db.exerciseQueries.selectAll(mapper = ::toExercise).asFlow().mapToList(Dispatchers.IO)
